...
// TODO: styles would need to be fixed here to make them JSX compatible
						...
						<ul>
							<li>
								<a id="evaluate" href="#" title="Evaluate circuit">
									Evaluate
									{/* <div style="float:right; font-size: 11px">Enter</div> */}
									<div>Enter</div>
								</a>
							</li>
							<li>
								<a id="compile" href="#" title="Compile circuit to gate">
									Compile
									{/* <div style="float:right; font-size: 11px">Ctrl+S</div> */}
									<div>Ctrl+S</div>
								</a>
							</li>
							<li>
