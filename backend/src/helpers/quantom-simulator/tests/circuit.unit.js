        ...
        it("Should evaluate the circuit", () => {
            ...
            var gate = {
                type: {
                    ...
                    qubits: 1,
                    matrix: {
                        x: [[0.7071067811865475, 0.7071067811865475], [0.7071067811865475, -0.7071067811865475]],
                        y: [[0, 0], [0, 0]]
                    }
                },
                time: gates[0].time + 1,
            ...
            circuit.evaluate(
                ...
                (progess_percent) => { },
                (amplitude) => {
                    expect(amplitude.x).to.deep.equal([0.7071067811865475, 0, 0.7071067811865475, 0]);
